...
@section('content')
    <div class="container">
        <div class="row my-5">
            <div class="col-md-8">
                <div class="card">
                    <div class=" bg-primary card-header"><h5 style="color: white">{{ __('Derniers Questions') }}</h5></div>
                    <div class="card-body">
                        <ul class="list-group">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header bg-success"><h5 style="color: white">{{ __('Categories') }}</h5></div>
